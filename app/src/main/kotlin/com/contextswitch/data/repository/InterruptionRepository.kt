package com.contextswitch.data.repository

import com.contextswitch.data.api.ContextSwitchApi
import com.contextswitch.data.api.InterruptionEvent
import com.contextswitch.data.db.Interruption
import com.contextswitch.data.db.InterruptionDao
...
class InterruptionRepository(
    ...
    private val api: ContextSwitchApi
) {
